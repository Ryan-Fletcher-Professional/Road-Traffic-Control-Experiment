# This transportation network when run won't have traffic initially, and traffic begins only when the time is 57600s. 
# The beginning time of a network can be found in the sumocfg file of the network. 
...
root.withdraw()
directory = ""
directory = filedialog.askdirectory(title="Select Traffic Data Directory of the ingolstad21 network")
...
for i_episode in range(num_episodes):
    ...
    #info can be got too if single agent
    state, info =  env.reset()
